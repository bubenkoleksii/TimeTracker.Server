...
public interface IUserRepository
{
    ...
    public Task<PaginationDataResponse<UserDataResponse>> GetAllUsersAsync(int offset, int limit, string search, int? filteringEmploymentRate, string? sortingColumn);
