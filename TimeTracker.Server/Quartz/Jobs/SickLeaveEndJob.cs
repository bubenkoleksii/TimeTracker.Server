...
public class SickLeaveEndJob : IJob
{
    private readonly IUserRepository _userRepository;
    private readonly ISickLeaveRepository _sickLeaveRepository;

    public SickLeaveEndJob(IUserRepository userRepository, ISickLeaveRepository sickLeaveRepository)
    {
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        {
            if (sickLeave.End.Date == DateTime.Today)
            {
